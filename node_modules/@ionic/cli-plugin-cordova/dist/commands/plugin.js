...
let PluginCommand = class PluginCommand extends base_1.CordovaCommand {
    preInputsPrompt(inputs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (inputs[0] === 'list') {
                const response = yield this.runCordova(['plugin', 'list']);
    ...
    run(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!pluginName) {
                ...
                const promptResults = yield inquirer.prompt({
            ...
            yield this.runCordova(cordova_1.gatherArgumentsForCordova(this.metadata, inputs, normalizedOptions));
        });
    }
};
